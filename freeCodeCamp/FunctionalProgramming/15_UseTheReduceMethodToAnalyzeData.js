...
//var tot = watchList.reduce(function(acc,item,index,arr) {
var averageRating = watchList.reduce((acc,item,index,arr) => {
    if (item.Director == "Christopher Nolan") {
       acc += Number(item.imdbRating);
     }
...
different elements of the array. For example, if you want to compare elements of the array, or add them together, 
