...
//rating = watchList.map((item, index, array) => { return {title: item.Title, rating: item.imdbRating} });

//Do not need to pass item, index, array
//rating = watchList.map((item, index, array) => { return {title: item.Title, rating: item.imdbRating} });

rating = watchList.map((item) => { return {title: item.Title, rating: item.imdbRating} });

// let rating = watchList.map(function(item, index, array) {
//         return {
//             title: item.Title,
