...
function urlSlug(title) {
    let arr = title.trim().split(/\W+/g);    //Put the string into an array.
...
powerful method used to reduce problems to simpler forms. From computing averages to sorting, 
any array operation can be achieved by applying it. Recall that map and filter are special cases of reduce.
