function Dog(name, color) {
  ...
  let terrier = new Dog("Tucker", "White");
...
of different birds in an aviary. It would take a lot of time to create all the birds, 
...
at the time it is created, which is one way that JavaScript constructors are so useful. 
They group objects together based on shared characteristics and behavior and define a 
